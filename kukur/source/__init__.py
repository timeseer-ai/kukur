...
_FACTORY: dict[str, Callable[..., SourceProtocol]] = {
    ...
    "databricks-sql": databricks_sql.from_config,
    "datafusion": datafusion.from_config,
    "delta": delta.from_config,
    "elasticsearch": elasticsearch.from_config,
    "feather": feather.from_config,
    "flight-sql": flight_sql.from_config,
    ...
    "piwebapi-af": piwebapi_af.from_config,
    "piwebapi-af-template": piwebapi_af_template.from_config,
