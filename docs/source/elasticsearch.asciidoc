...
index = ""
metadata_index = ""
metadata_index_filter = {} # optional Elasticsearch Query DSL filter for metadata
list_query = ""
metadata_query = ""
...
The index can optionally be filtered by a https://www.elastic.co/docs/reference/query-languages/querydsl[Query DSL] filter.
