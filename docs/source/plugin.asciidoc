...
`0` is considered good and everything else is considered bad,
following the convention of Unix exit codes.

To return the quality status codes of the underlying source instead,
