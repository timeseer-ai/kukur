...
>>> client = Client()
>>> client.get_metadata(SeriesSelector('example', 'outside-temperature'))
Metadata(series=SeriesSelector(source='example', name='outside-temperature'), description='', unit='', limit_low=None, limit_high=None, accuracy=None, interpolation_type=None, data_type=None, dictionary_name=None, dictionary=None, process_type=None)
----

NOTE: when using API keys, use the `data_dir` configuration option to store them in another volume mounted location.
